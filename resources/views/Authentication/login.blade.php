      ...
      <div class="authentication-inner py-4">
        ...
        <div class="card p-2">
            ...
            <span class="app-brand-logo   me-1">
                          <span style="color: var(--bs-primary)">
                              <!-- <svg width="30" height="24" viewBox="0 0 250 196" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <img src="{{ asset('assets/img/logo/account.png') }}" alt="Your Alt Text" class="your-class-name" width="300.5" height="150" />

                          </span>
                      </span>
              <!-- <span class="app-brand-text demo text-heading fw-semibold">Garage</span> -->
            </a>
          </div>
          <!-- /Logo -->
          ...
          <div class="card-body mt-2">
            ...
            @endif
            <form id="formAuthentication" class="mb-3 needs-validation" method="POST" action="{{route('auth.doLogin')}}">
              @csrf
              <div class="form-floating form-floating-outline mb-3">
                <input type="email" id="bs-validation-email" name="email" class="form-control email" placeholder="Enter your email" />
              ...
              <div class="mb-4 form-password-toggle">
                <div class="input-group input-group-merge">
                  ...
                  <div class="invalid-feedback" id="password-feedback"> Please enter a valid password. </div>
                </div>
              </div>
        ...
        <img src="{{ asset('assets/img/illustrations/auth-basic-mask-light.png') }}" class="authentication-image d-none d-lg-block" alt="triangle-bg" data-app-light-img="illustrations/auth-basic-mask-light.png" data-app-dark-img="illustrations/auth-basic-mask-dark.png" />
